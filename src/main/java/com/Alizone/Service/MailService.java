...
public class MailService {
    ...
    public String buildCustomerOrderMail(Order order) {
        ...
        """.formatted(
                a.getAliciAdiSoyadi(),
                a.getAdresSatir1(),
                a.getAdresSatir2() == null ? "" : a.getAdresSatir2(),
                a.getIlce(),
                a.getSehir(),
                a.getPostaKodu(),
                a.getUlke(),
        ...
        if (a.getFaturaTipi() != null) {
            ...
            """.formatted(
                    a.getFaturaTipi(),
                    a.getFaturaAdiSoyadi() == null ? "" : a.getFaturaAdiSoyadi(),
                    a.getTcKimlikNo() == null ? "" : a.getTcKimlikNo(),
                    a.getFirmaAdi() == null ? "" : a.getFirmaAdi(),
    ...
    public String buildShippedMail(Order order) {
        ...
        """.formatted(
                ...
                order.getShippedAt().toLocalDate()
        ));
